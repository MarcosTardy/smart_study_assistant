...
Recommended model names to try (depend on your Gemini account and API version):

- `gemini-1.0` (recommended default)
- `gemini-1.1` (newer generation, if available)
...
$env:GEMINI_MODEL = "gemini-1.0"  # optional
```
